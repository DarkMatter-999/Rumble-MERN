...
import { deleteUser, findUser, friendUser, getFriends, getUser, unfriendUser, updatePasswd, updateUser } from '../Controllers/UserController.js'
...
router.post('/friends', authMiddleware, getFriends)
